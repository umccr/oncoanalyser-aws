...
echo "app config settings"
echo $ONCOANALYSER_NEXTFLOW_CONFIG_APPCONFIG_APPLICATION
echo $ONCOANALYSER_NEXTFLOW_CONFIG_APPCONFIG_ENVIRONMENT
echo $ONCOANALYSER_NEXTFLOW_CONFIG_APPCONFIG_CONFIGURATION_PROFILE
echo "printed app config settings"
