...
export class NextflowConfigConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: NextflowConfigProps) {
    ...
    this.application = new appconfig.Application(this, "AppConfigApplication", { });
    ...
    this.hostedConfiguration = new appconfig.HostedConfiguration(
      ...
      {
        description: "Default configuration for this deployment of Oncoanalyser - this config is autogenerated from a template and should not be edited",
        application: this.application,
